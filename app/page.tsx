	...
	return (
		<main className="flex flex-col items-center justify-between px-24">
			<div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pb-16 pt-24 text-center">
				<h1 className="mx-auto max-x-4xl text-5xl font-bold tracking-tight sm:text-7xl text-slate-900 dark:text-gray-200">
				...
				<p className="mx-auto mt-8 max-w-2xl text-2xl tracking-tight text-slate-700 dark:text-slate-500">
